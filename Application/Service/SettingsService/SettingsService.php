...
namespace NHAzureLogicApps\Application\Service\SettingsService;
...
{
    const INTEGRATION_SETTINGS = "nhala_intgr_st";
    const INTEGRATION_SETTING_EVENT = "nhala_intgr_stevent";
    ...
    public function saveIntegrationSettings(IntegrationSettingsModel $settingsModel)
    {
        $settings = [
            ...
            'endpointUrl' => esc_url_raw($settingsModel->endpointUrl),
