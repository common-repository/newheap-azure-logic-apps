    ...
    public function register()
    {
        add_action('post_updated', function($postId, $postAfter, $postBefore){
            ...
            foreach($this->getIntegrations() as $integration)
            {
                ...
                $messageModel->text = $this->renderMessage($integration, $postId, $postAfter);
                $messageModel->attachments[] = $this->getAttachment($integration, $postId, $postAfter);
                $messageModel->data = $this->getData($integration, $postId, $postAfter);
